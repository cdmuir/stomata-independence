...
# 17_summarize-fit ----
mo = read_rds("objects/modeloutput.rds")
...
\textit{Manuscript elements}: Figure 1, figure 2, figure 3, figure 4, figure 5, table 1, online appendix A (including Notes A1, table A1, table A2, and table A3).

\bigskip

\textit{Keywords}: adaptation, amphistomy, developmental integration, leaf, phylogenetic comparative methods, stomata
...
Unless otherwise mentioned, we performed all data wrangling and statistical analyses in *R* version `r as.character(getRversion())` [@r_core_team_r:_2021]. Source code is publically available on GitHub (https://github.com/cdmuir/stomata-independence) and will be archived on Zenodo upon publication.
...
The final data set and phylogeny used in the analysis are included in the [Supporting Information]. The raw anatomical data and source code will be archived on Zenodo upon publication.
...
```{r}
library(ape)
write.tree(trimmed_phy, "ms/notesA1.new")
```
...
write_csv(pair_div, "ms/tableS2.csv")
```
...
\begin{tabular}{lll}
  ...
  \\
  $D_\mathrm{ab}$ & `r mo$mu["D_ab", "value"]`  & `r mo$mu["D_ab", "hdi"]`  \\
  $D_\mathrm{ad}$ & `r mo$mu["D_ad", "value"]`  & `r mo$mu["D_ad", "hdi"]`  \\
  $L_\mathrm{ab}$ & `r mo$mu["L_ab", "value"]`  & `r mo$mu["L_ab", "hdi"]`  \\
  $L_\mathrm{ad}$ & `r mo$mu["L_ad", "value"]`  & `r mo$mu["L_ad", "hdi"]`  \\
  \\
  \multicolumn{3}{l}{Standard deviation of $\Delta \text{log(trait)}$} \\
  \\
  $D_\mathrm{ab}$ & `r mo$sigma["D_ab", "value"]`  & `r mo$sigma["D_ab", "hdi"]`  \\
  $D_\mathrm{ad}$ & `r mo$sigma["D_ad", "value"]`  & `r mo$sigma["D_ad", "hdi"]`  \\
  $L_\mathrm{ab}$ & `r mo$sigma["L_ab", "value"]`  & `r mo$sigma["L_ab", "hdi"]`  \\
  $L_\mathrm{ad}$ & `r mo$sigma["L_ad", "value"]`  & `r mo$sigma["L_ad", "hdi"]`  \\
  \\
  \multicolumn{3}{l}{Effect of pair age on standard deviation of $\Delta \text{log(trait)}$} \\
  \multicolumn{3}{l}{log-link scale} \\
  \\
  $D_\mathrm{ab}$ & `r mo$age["D_ab", "value"]`  & `r mo$age["D_ab", "hdi"]`  \\
  $D_\mathrm{ad}$ & `r mo$age["D_ad", "value"]`  & `r mo$age["D_ad", "hdi"]`  \\
  $L_\mathrm{ab}$ & `r mo$age["L_ab", "value"]`  & `r mo$age["L_ab", "hdi"]`  \\
  $L_\mathrm{ad}$ & `r mo$age["L_ad", "value"]`  & `r mo$age["L_ad", "hdi"]`  \\
  \\
  \multicolumn{3}{l}{Correlation between $\Delta \text{log(trait)}$} \\
  \\
  $D_\mathrm{ab}-D_\mathrm{ad}$ & 
  `r mo$cor["D_ab-D_ad", "value"]`  & `r mo$cor["D_ab-D_ad", "hdi"]`  \\
  $D_\mathrm{ab}-L_\mathrm{ab}$ & 
  `r mo$cor["D_ab-L_ab", "value"]`  & `r mo$cor["D_ab-L_ab", "hdi"]`  \\
  $D_\mathrm{ab}-L_\mathrm{ad}$ & 
  `r mo$cor["D_ab-L_ad", "value"]`  & `r mo$cor["D_ab-L_ad", "hdi"]`  \\
  $D_\mathrm{ad}-L_\mathrm{ab}$ & 
  `r mo$cor["D_ad-L_ab", "value"]`  & `r mo$cor["D_ad-L_ab", "hdi"]`  \\
  $D_\mathrm{ad}-L_\mathrm{ad}$ & 
  `r mo$cor["D_ad-L_ad", "value"]`  & `r mo$cor["D_ad-L_ad", "hdi"]`  \\
  $L_\mathrm{ab}-L_\mathrm{ad}$ & 
  `r mo$cor["L_ab-L_ad", "value"]`  & `r mo$cor["L_ab-L_ad", "hdi"]`  \\
  \\
  \multicolumn{3}{l}{Student $t$ famil parameter $\nu$} \\
  \\
  $-$ & `r mo$nu["nu", "value"]`  & `r mo$nu["nu", "hdi"]`  \\
