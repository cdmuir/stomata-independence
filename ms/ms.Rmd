...
**Note S1:** Final fully resolved bifurcating phylogenetic tree of `r n_tax3` taxa in Newick format.
```{r}
library(ape)
write.tree(trimmed_phy, "ms/notesS1.new.txt")
```
